...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  1 14:36:43 2022

@author: vanessa
"""

# this notebook contains the basic two-lithology fluvial model
# no bells and whistles yet
# on the to-do list:
    # write in terms of Q in order to dynaimcally calculate width
    # write q_s to honor basin geometry (uniform lowering of a widening valley)
...
def two_lith_one_sed(x,
    ...
    return (S, qs, eta, etab, bedrock_ero, atr, sedimentation_rate, H, total_ero)